...
exports.getStats = async (req, res) => {
  try {
    ...
    const totalCountries = await require('../models/Country.cjs').countDocuments({ isActive: true });
    const totalProfessions = await require('../models/Profession.cjs').countDocuments({ isActive: true });
